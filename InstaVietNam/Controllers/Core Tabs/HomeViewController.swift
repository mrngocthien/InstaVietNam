...
struct HomeFeadRenderViewModel {
...
class HomeViewController: UIViewController {
    ...
    private var feedRenderModels = [HomeFeadRenderViewModel]()
    ...
    private func CreateMockModels() {
        let user = User(username: "@ngoc_thien",
                        bio: "",
                        name: (first: "", last: ""),
        ...
        for x in 0..<5 {
            let viewModel = HomeFeadRenderViewModel(
                header: PostRenderViewModel(renderType: .header(provide: user)),
...
extension HomeViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        let x = section
        let model: HomeFeadRenderViewModel
        if x == 0 {
