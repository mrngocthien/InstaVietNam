...
protocol ProfileTableCollectionReusableViewdDelegate: AnyObject {
    func didTapGridButtonTab()
    func didTapTaggedButtonTab()
}

class ProfileTableCollectionReusableView: UICollectionReusableView {
    static let indentifier = "ProfileTableCollectionReusableView"

    public weak var delegate: ProfileTableCollectionReusableViewdDelegate?
